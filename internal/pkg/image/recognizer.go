...
func NewRecognizer(modelPath, labelPath string, inputH, inputW int) (*Recognizer, error) {
...
func (r *Recognizer) PredictFromFile(imagePath string) (string, error) {
...
func (r *Recognizer) PredictFromBuffer(buf []byte) (string, error) {
...
func (r *Recognizer) PredictFromImage(img image.Image) (string, error) {
